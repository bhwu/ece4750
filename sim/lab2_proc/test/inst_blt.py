...
def gen_src0_dep_nottaken_test():
  return [
    ...
    gen_br2_src0_dep_test( 4, "blt", 2, 1, False ),
...
def gen_src1_dep_taken_test():
  return [
    ...
    gen_br2_src1_dep_test( 4, "bge", 2, 3, True ),
    gen_br2_src1_dep_test( 3, "bge", 3, 4, True ),
    gen_br2_src1_dep_test( 2, "bge", 4, 5, True ),
    gen_br2_src1_dep_test( 1, "bge", 5, 6, True ),
    gen_br2_src1_dep_test( 0, "bge", 6, 7, True ),
  ]
...
def gen_src1_dep_nottaken_test():
  return [
    gen_br2_src1_dep_test( 5, "blt", 1, 0, False ),
    gen_br2_src1_dep_test( 4, "blt", 2, 1, False ),
    gen_br2_src1_dep_test( 3, "blt", 3, 2, False ),
...
def gen_value_test():
  return [
    ...
    gen_br2_value_test( "blt", -1, -2, False  ),
