...
def test_add_rand_delays( dump_vcd ):
  run_test( ProcBaseRTL,
            inst_add.gen_random_test,
            dump_vcd,
            src_delay = 3,
            sink_delay = 5,
            mem_stall_prob = 0.5,
...
@pytest.mark.parametrize( "name,test", [
  ...
  asm_test( inst_mul.gen_value_dir_test  ) ,
  asm_test( inst_mul.gen_value_lom_test  ) ,
  asm_test( inst_mul.gen_value_midm_test ) ,
  asm_test( inst_mul.gen_value_sprs_test ) ,
  asm_test( inst_mul.gen_value_dens_test ) ,
  asm_test( inst_mul.gen_consec_mul_test ) ,
