...
def gen_src0_dep_taken_test():
  return [
    ...
    gen_br2_src0_dep_test( 4, "bgeu", 2, 1, True ),
    gen_br2_src0_dep_test( 3, "bgeu", 3, 2, True ),
...
def gen_src1_dep_taken_test():
  return [
    gen_br2_src1_dep_test( 5, "bgeu", 1, 0, True ),
    gen_br2_src1_dep_test( 4, "bgeu", 2, 1, True ),
    gen_br2_src1_dep_test( 3, "bgeu", 3, 2, True ),
...
def gen_value_test():
  return [
    ...
    gen_br2_value_test( "bgeu", -1, -2, True  ),
