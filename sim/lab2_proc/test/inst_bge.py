...
def gen_src0_dep_taken_test():
  return [
    ...
    gen_br2_src0_dep_test( 4, "bge", 2, 1, True ),
    gen_br2_src0_dep_test( 3, "bge", 3, 2, True ),
...
def gen_src1_dep_taken_test():
  return [
    gen_br2_src1_dep_test( 5, "bge", 1, 0, True ),
    gen_br2_src1_dep_test( 4, "bge", 2, 1, True ),
    gen_br2_src1_dep_test( 3, "bge", 3, 2, True ),
