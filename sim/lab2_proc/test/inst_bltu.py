...
def gen_src0_dep_nottaken_test():
  return [
    ...
    gen_br2_src0_dep_test( 4, "bltu", 2, 1, False ),
...
def gen_src1_dep_nottaken_test():
  return [
    gen_br2_src1_dep_test( 5, "bltu", 1, 0, False ),
    gen_br2_src1_dep_test( 4, "bltu", 2, 1, False ),
    gen_br2_src1_dep_test( 3, "bltu", 3, 2, False ),
...
def gen_value_test():
  return [
    ...
    gen_br2_value_test( "bltu", -1, -2, False  ),
