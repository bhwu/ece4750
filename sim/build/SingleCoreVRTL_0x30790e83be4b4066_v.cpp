//======================================================================
// VSingleCoreVRTL_0x30790e83be4b4066_v.cpp
//======================================================================
// This wrapper exposes a C interface to CFFI so that a
// Verilator-generated C++ model can be driven from Python.
//

#include "obj_dir_SingleCoreVRTL_0x30790e83be4b4066/VSingleCoreVRTL_0x30790e83be4b4066.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_SingleCoreVRTL_0x30790e83be4b4066/VSingleCoreVRTL_0x30790e83be4b4066__Syms.h"
#include "svdpi.h"
#endif
...
VSingleCoreVRTL_0x30790e83be4b4066_t * create_model( const char *vcd_filename ) {

  VSingleCoreVRTL_0x30790e83be4b4066_t * m;
  VSingleCoreVRTL_0x30790e83be4b4066   * model;

  Verilated::randReset( 0 );

  m     = (VSingleCoreVRTL_0x30790e83be4b4066_t *) malloc( sizeof(VSingleCoreVRTL_0x30790e83be4b4066_t) );
  model = new VSingleCoreVRTL_0x30790e83be4b4066();
...
void destroy_model( VSingleCoreVRTL_0x30790e83be4b4066_t * m ) {

  VSingleCoreVRTL_0x30790e83be4b4066 * model = (VSingleCoreVRTL_0x30790e83be4b4066 *) m->model;
...
void eval( VSingleCoreVRTL_0x30790e83be4b4066_t * m ) {
...
#if VLINETRACE
void trace( VSingleCoreVRTL_0x30790e83be4b4066_t * m, char* str ) {
