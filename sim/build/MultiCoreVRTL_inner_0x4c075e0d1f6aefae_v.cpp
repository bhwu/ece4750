//======================================================================
// VMultiCoreVRTL_inner_0x4c075e0d1f6aefae_v.cpp
//======================================================================
// This wrapper exposes a C interface to CFFI so that a
// Verilator-generated C++ model can be driven from Python.
//

#include "obj_dir_MultiCoreVRTL_inner_0x4c075e0d1f6aefae/VMultiCoreVRTL_inner_0x4c075e0d1f6aefae.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_MultiCoreVRTL_inner_0x4c075e0d1f6aefae/VMultiCoreVRTL_inner_0x4c075e0d1f6aefae__Syms.h"
#include "svdpi.h"
#endif
...
VMultiCoreVRTL_inner_0x4c075e0d1f6aefae_t * create_model( const char *vcd_filename ) {

  VMultiCoreVRTL_inner_0x4c075e0d1f6aefae_t * m;
  VMultiCoreVRTL_inner_0x4c075e0d1f6aefae   * model;

  Verilated::randReset( 0 );

  m     = (VMultiCoreVRTL_inner_0x4c075e0d1f6aefae_t *) malloc( sizeof(VMultiCoreVRTL_inner_0x4c075e0d1f6aefae_t) );
  model = new VMultiCoreVRTL_inner_0x4c075e0d1f6aefae();
  ...
  m->reset = &model->reset;
  m->clk = &model->clk;
  m->dcache_access = &model->dcache_access;
  m->dcache_miss = &model->dcache_miss;
  m->icache_access = &model->icache_access;
  m->icache_miss = &model->icache_miss;
...
void destroy_model( VMultiCoreVRTL_inner_0x4c075e0d1f6aefae_t * m ) {

  VMultiCoreVRTL_inner_0x4c075e0d1f6aefae * model = (VMultiCoreVRTL_inner_0x4c075e0d1f6aefae *) m->model;
...
void eval( VMultiCoreVRTL_inner_0x4c075e0d1f6aefae_t * m ) {
...
#if VLINETRACE
void trace( VMultiCoreVRTL_inner_0x4c075e0d1f6aefae_t * m, char* str ) {
